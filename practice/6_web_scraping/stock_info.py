...
# Getting the page with all of the most active stocks
...
body = get_page('https://finance.yahoo.com/most-active?offset=0&count=5')

# Making a list of all the stock codes
